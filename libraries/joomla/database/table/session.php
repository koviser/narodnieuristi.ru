	...
	function update( $updateNulls = false )
	{
		...
		if( !$ret ) {
			...
			if($this->userid>0){
				...
				$query = 'SELECT a.balance, a.bonus, a.refUse'
				. ' FROM #__users AS a'
				. ' WHERE a.id='.(int)$this->userid
				;
				...
				$user->set('balance', $balance->balance);
				$user->set('bonus', $balance->bonus);
				$user->set('refUse', $balance->refUse);
			}
			return true;
		}
	}
