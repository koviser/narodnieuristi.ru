...
class JHTMLGrid
{
	...
	*/
	...
	function publishedExt( &$row, $i)
	{
		switch($row){
			case 1:
				$href = '
				<a href="javascript:void(0);" onclick="return listItemTask(\'cb'. $i .'\',\'unpublish\')" title="'. JText::_( 'Unusing' ) .'">
				<img src="images/tick.png" border="0" alt="'. JText::_( 'use' ) .'" /></a>'
				;
				break;
			case 2:
				$href = '<img src="images/publish_y.png" border="0" alt="'. JText::_( 'Moneyback' ) .'" />'
				;
				break;
			default:
				$href = '
				<a href="javascript:void(0);" onclick="return listItemTask(\'cb'. $i .'\',\'publish\')" title="'. JText::_( 'Using' ) .'">
				<img src="images/publish_x.png" border="0" alt="'. JText::_( 'notuse' ) .'" /></a>'
				;
		}
	...
	function publishedExtFront( &$row, $i)
	{
		switch($row){
			case 1:
				$href = '<img src="images/tick.png" border="0" alt="'. JText::_( 'use' ) .'" />'
				;
				break;
			default:
				$href = '
				<a href="index.php?option=com_user&task=status&order='.$i.'" title="'. JText::_( 'Using' ) .'">
				<img src="images/publish_x.png" border="0" alt="'. JText::_( 'notuse' ) .'" /></a>'
				;
		}
