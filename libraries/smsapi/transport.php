...
class Transport{
	...
	function __construct(){
		...
		define("HTTPS_LOGIN", $mainframe->getCfg('sms_login')); //Ваш логин для HTTPS-протокола
		define("HTTPS_PASSWORD", $mainframe->getCfg('sms_password')); //Ваш пароль для HTTPS-протокола
		...
		define("HTTP_ADDRESS", "http://sms-uslugi.ru/API/XML/"); //HTTPS-Адрес, к которому будут обращаться скрипты. Со слэшем на конце.
