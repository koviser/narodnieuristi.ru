...
<div id="left">
    ...
    <div id="description">
    	<div id="terms">
       	...
       	<div id="info">
        	<span><?php echo JText::_('Information'); ?></span><span><a href="index.php?option=com_coupon&view=bonus&id=<?php echo $this->items->id; ?>&layout=comments"><?php echo JText::_('Comments'); ?></a></span>
            <span>
