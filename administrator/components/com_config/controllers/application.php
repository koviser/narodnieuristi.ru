...
class ConfigControllerApplication extends ConfigController
{
	...
	function save()
	{
		...
		$config_array['wm_login']	= JRequest::getVar('wm_login', '', 'post', 'string');
		$config_array['wm_password_1']	= JRequest::getVar('wm_password_1', '', 'post', 'string');
		$config_array['wm_password_2']	= JRequest::getVar('wm_password_2', '', 'post', 'string');
		$config_array['wm_url']	= JRequest::getVar('wm_url', '', 'post', 'string');
		$config_array['yandex_key']	= JRequest::getVar('yandex_key', '', 'post', 'string');
		$config_array['start_bonus']	= JRequest::getVar('start_bonus', 0, 'post', 'int');
		$config_array['friend_bonus']	= JRequest::getVar('friend_bonus', 0, 'post', 'int');
		$config_array['user_bonus']	= JRequest::getVar('user_bonus', 0, 'post', 'int');
		
		$config_array['vk_id']	= JRequest::getVar('vk_id', '', 'post', 'string');
		$config_array['vk_password']	= JRequest::getVar('vk_password', '', 'post', 'string');
		$config_array['fb_id']	= JRequest::getVar('fb_id', '', 'post', 'string');
		$config_array['fb_password']	= JRequest::getVar('fb_password', '', 'post', 'string');
		$config_array['mail_ru_id']	= JRequest::getVar('mail_ru_id', '', 'post', 'string');
		$config_array['mail_ru_password']	= JRequest::getVar('mail_ru_password', '', 'post', 'string');
		$config_array['mail_ru_key']	= JRequest::getVar('mail_ru_key', '', 'post', 'string');
		
		$config_array['sms_login']	= JRequest::getVar('sms_login', '', 'post', 'string');
		$config_array['sms_password']	= JRequest::getVar('sms_password', '', 'post', 'string');
