...
class UsersViewUsers extends JView
{
	function display($tpl = null)
	{
		...
		if (!in_array($filter_order, array('a.name', 'a.username', 'a.block', 'groupname', 'a.email', 'a.lastvisitDate', 'a.id', 'a.vip', 'a.lider', 'a.frequent', 'a.bonus', 'a.balance', 'b.title', 'a.advertiser'))) {
			$filter_order = 'a.name';
		}
		...
		$query = 'SELECT a.*, g.name AS groupname, c.title'
			. ' FROM #__users AS a'
			. ' LEFT JOIN #__7t_doc_roo AS c ON a.id_roo=c.id'
