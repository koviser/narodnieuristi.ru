...
<?php
	...
	//JToolBarHelper::customX( 'transaction', 'pay.png', 'pay_f2.png', JText::_( 'Payment history' ), false );
	...
	<table class="adminlist" cellpadding="1">
		<thead>
			<tr>
                ...
                <!--
                <th class="title" >
					<?php echo JHTML::_('grid.sort',   'Balance', 'a.balance', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
				</th>
                <th class="title">
					<?php echo JHTML::_('grid.sort',   'Bonus', 'a.bonus', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
				</th>
                -->
                <th class="title">
				...
				<th class="title">
					<?php echo JHTML::_('grid.sort',   'Family', 'a.family', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
				</th>
                <th class="title">
					<?php echo JHTML::_('grid.sort',   'РОО', 'c.title', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
				</th>
				...
				<th width="5%" class="title">
					<?php echo JHTML::_('grid.sort',   'advertiser', 'a.advertiser', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
				</th>
                <th width="5%" class="title">
					<?php echo JHTML::_('grid.sort',   'referal', 'a.partner', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
				</th>
                <th width="5%" class="title">
					<?php echo JHTML::_('grid.sort',   'vip', 'a.vip', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
				</th>
                -->
		...
		<?php
			...
			<tr class="<?php echo "row$k"; ?>">
                ...
                <!--
                <td align="center">
					<?php echo $row->advertiser ? '<img src="images/tick.png" width="16" height="16" border="0" alt="" />': ''; ?>
				</td>
                <td align="center">
                	<?php 
						if($row->partner){
							echo '<img src="images/ref_'.$row->partner.'.png" width="16" height="16" border="0" alt="" />';
						}
					?>
				</td>
                <td align="center">
					<?php echo $row->vip ? '<img src="images/tick.png" width="16" height="16" border="0" alt="" />': ''; ?>
				</td>
                -->
				<td nowrap="nowrap">
					<?php echo $lvisit; ?>
