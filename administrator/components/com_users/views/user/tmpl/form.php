...
<?php JHTML::_('behavior.tooltip'); JHTML::_('behavior.modal', 'a.modal-button'); ?>
...
<form action="index.php" method="post" name="adminForm" autocomplete="off">
		...
		<legend><?php echo JText::_( 'User Details' ); ?></legend>
			<table class="admintable" cellspacing="1">
                ...
                <tr>
					...
					<td>
						<input type="text" name="family" id="family" class="inputbox" size="40" value="<?php echo $this->user->get('family'); ?>" />
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
                ...
                <tr>
					...
					<td>
						<?php echo $this->user->get('birthDay'); ?>
					</td>
				</tr>
                <tr>
					<td width="150" class="key">
    ...
    <!--
		<fieldset class="adminform">
		<legend><?php echo JText::_( 'REFERAl PROGRAMM' ); ?></legend>
			<table class="admintable">
				<tr>
					<td valign="top" class="key">
						<label for="partner">
							<?php echo JText::_( 'Referal' ); ?>
						</label>
					</td>
					<td>
						<?php echo $this->lists['partner']; ?>
					</td>
				</tr>
                <tr>
					<td valign="top" class="key">
						<label for="reward">
							<?php echo JText::_( 'Reward' ); ?>
						</label>
					</td>
					<td>
						<input class="inputbox" type="text" name="reward" id="reward" size="10" value="<?php echo $this->user->get('reward');?>"/> <span id="sefvalue"></span>
					</td>
				</tr>
                <tr>
					<td valign="top" class="key">
						<?php echo JText::_( 'Ref url' ); ?>
					</td>
					<td>
						?ref=<span id="reflink"></span>
					</td>
				</tr>
                <tr>
                	<td class="key">&nbsp;</td>
                	<td>
                        <div class="button2-left" style="display:inline">
                            <div class="image">
                                <a class="modal-button" title="<?php echo JText::_('Report'); ?>" href="index.php?option=com_users&amp;view=report&amp;tmpl=component&amp;id=<?php echo $this->user->get('id');?>" rel="{handler: 'iframe', size: {x: 640, y: 600}}"><?php echo JText::_('Report'); ?></a>
                            </div>
                        </div>
					</td>
                </tr>
                <tr>
                	<td class="key"><?php echo JText::_('SATTLE UP'); ?></td>
                	<td>
                    	<div style="clear:both; padding:0 0 5px 5px;"><input class="inputbox" type="text" name="size" id="size" size="10" value="<?php echo $this->user->get('balance');?>"/> <?php echo JText::_('rub'); ?></div>
                        <div class="button2-left" style="display:inline;">
                            <div class="image">
                                <a href="#" id="sattle"><?php echo JText::_('Make a payment'); ?></a>
                            </div>
                        </div>
					</td>
                </tr>
...
<form action="index.php" method="post" name="adminForm2" id="paymentForm" autocomplete="off">
