...
<?php
	...
	JToolBarHelper::title( JText::_( 'News item' ) . ': <small><small>[ '. $text .' ]</small></small>' , 'frontpage' );	
	JToolBarHelper::save();
		...
		<legend><?php echo JText::_( 'DESCRIPTION' ) ?></legend>
			<table class="admintable" cellspacing="1" style="width:800px">
				<tr>
					...
					<td>
						<input type="text" name="title" id="title" class="inputbox" size="90" value="<?php echo $this->escape($this->item->get('title')); ?>" />
					</td>
				</tr>
                <tr>
                ...
                <tr>
					<td colspan="2">
						<?php
							...
							echo $editor->display( 'full_text',  $this->item->get('full_text') , '100%', '400', '60', '20', array() ) ;
						?>
					</td>
				</tr>
			</table>					
