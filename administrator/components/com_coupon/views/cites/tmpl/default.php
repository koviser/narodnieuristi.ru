...
<?php
	JToolBarHelper::title(JText::_('CITY MANAGER'), 'pict.png' );		
...
<form action="index.php" method="post" name="adminForm">
	...
	<table class="adminlist" cellpadding="1">
		<thead>
			<tr>
				...
				<th class="title" style="text-align:left;">
					<?php echo JHTML::_('grid.sort', JText::_('CITY'), 'a.title', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>
		...
		<?php
			...
			{
				$row 	=& $this->items[$i];
				$link 	= 'index.php?option=com_coupon&amp;controller=city&amp;view=city&amp;task=edit&amp;cid[]='. $row->id. '';
