...
<?php
	JToolBarHelper::title(JText::_('BONUS MANAGER'), 'frontpage' );		
	...
	<table class="adminlist" cellpadding="1">
		<thead>
			<tr>
                ...
                <th class="title">
					<?php echo JHTML::_('grid.sort', JText::_('sale'), 'a.sale', $this->lists['order_Dir'], $this->lists['order'] ); ?>
				</th>	
                <th class="title">
		...
		<?php
			...
			{
				$row 	=& $this->items[$i];
				$link 	= 'index.php?option=com_coupon&amp;controller=bonus&amp;view=bonus&amp;task=edit&amp;cid[]='. $row->id. '';
