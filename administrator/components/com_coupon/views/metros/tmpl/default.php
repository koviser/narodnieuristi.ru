...
<?php
	JToolBarHelper::title(JText::_('METRO MANAGER'), 'pict.png' );		
...
<form action="index.php" method="post" name="adminForm">
	...
	<table class="adminlist" cellpadding="1">
		...
		<?php
			...
			{
				$row 	=& $this->items[$i];
				$link 	= 'index.php?option=com_coupon&amp;controller=metro&amp;view=metro&amp;task=edit&amp;cid[]='. $row->id. '';
			?>
	...
	<input type="hidden" name="controller" value="metro" />
